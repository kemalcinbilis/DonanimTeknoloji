...
namespace DonanımTeknoloji
{
    public partial class Form2 : Form
    {
        ...
        private void cb_FirmaAdi_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void tb_GörüsülenKisi_TextChanged(object sender, EventArgs e)
        {
        ...
        private void lbl_Modül_Click(object sender, EventArgs e)
        {

        }

        private void cb_Modül_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lbl_Aciklama_Click(object sender, EventArgs e)
        {

        }

        private void tb_Aciklama_TextChanged(object sender, EventArgs e)
        {
        ...
        private void lbl_İslemDurumu_Click(object sender, EventArgs e)
        {

        }

        private void cb_İslemDurumu_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void lbl_ŞifreAciklama_Click(object sender, EventArgs e)
        {
        ...
        private void lbl_BaslangicTarihi_Click(object sender, EventArgs e)
        {

        }

        private void lbl_BitisTarihi_Click(object sender, EventArgs e)
        {

        }

        private void dtp_BaslangicTarihi_ValueChanged(object sender, EventArgs e)
        {

        }

        private void dtp_BitisTarihi_ValueChanged(object sender, EventArgs e)
        {

        }

        private void cb_Firma_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lbl_Firma_Click(object sender, EventArgs e)
        {
